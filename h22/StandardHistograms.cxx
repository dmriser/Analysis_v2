...
void StandardHistograms::Load(std::string inputFilename){
  ...
  for(int s=0; s<numberSector; s++){
    ...
    h1_ele_relPhi[s]     = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_ele_relPhi_sect%d_%s",s,name.c_str()));
    h1_ele_theta[s]      = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_ele_theta_sect%d_%s",s,name.c_str()));
    h1_part1_p[s]        = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_p_sect%d_%s",s,name.c_str()));
    h1_part1_phi[s]      = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_phi_sect%d_%s",s,name.c_str()));
    h1_part1_relPhi[s]   = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_relPhi_sect%d_%s",s,name.c_str()));
    h1_part1_theta[s]    = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_theta_sect%d_%s",s,name.c_str()));
    h1_xbj[s]            = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_xbj_sect%d_%s",s,name.c_str()));
    h1_y[s]              = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_y_sect%d_%s",s,name.c_str()));
    ...
    h1_nu[s]             = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_nu_sect%d_%s",s,name.c_str()));
    h1_ele_rapidity[s]   = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_ele_rapidity_sect%d_%s",s,name.c_str()));
    h1_part1_rapidity[s] = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_rapidity_sect%d_%s",s,name.c_str()));
    
    // Detector Vars in 1-Dimension 
    h1_ele_nphe[s]               = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_ele_nphe_sect%d_%s",s,name.c_str()));
    h1_ele_ecInner[s]            = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_ele_ecInner_sect%d_%s",s,name.c_str()));
    h1_ele_ecOuter[s]            = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_ele_ecOuter_sect%d_%s",s,name.c_str()));
    h1_ele_samplingFraction[s]   = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_ele_samplingFraction_sect%d_%s",s,name.c_str()));
    h1_part1_nphe[s]             = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_nphe_sect%d_%s",s,name.c_str()));
    h1_part1_ecInner[s]          = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_ecInner_sect%d_%s",s,name.c_str()));
    h1_part1_ecOuter[s]          = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_ecOuter_sect%d_%s",s,name.c_str()));
    h1_part1_samplingFraction[s] = (TH1D*) inputFile->Get(Form("StandardHistograms/h1_part1_samplingFraction_sect%d_%s",s,name.c_str()));
    
    // Kinematic in 2-Dimensions
    h2_ele_p_theta[s]        = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_ele_p_theta_sect%d_%s",s,name.c_str()));
    h2_ele_phi_theta[s]      = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_ele_phi_theta_sect%d_%s",s,name.c_str()));
    h2_ele_relPhi_theta[s]   = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_ele_relPhi_theta_sect%d_%s",s,name.c_str()));
    h2_part1_p_theta[s]      = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_part1_p_theta_sect%d_%s",s,name.c_str()));
    h2_part1_phi_theta[s]    = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_part1_phi_theta_sect%d_%s",s,name.c_str()));
    h2_part1_relPhi_theta[s] = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_part1_relPhi_theta_sect%d_%s",s,name.c_str()));
    h2_xbj_q2[s]             = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_xbj_q2_sect%d_%s",s,name.c_str()));
    h2_w_q2[s]               = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_w_q2_sect%d_%s",s,name.c_str()));
    h2_y_w[s]                = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_y_w_sect%d_%s",s,name.c_str()));
    h2_z_pt2[s]              = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_z_pt2_sect%d_%s",s,name.c_str()));
    
    // Detector Vars in 2-Dimensions 
    h2_ele_p_samplingFraction[s]      = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_ele_p_samplingFraction_sect%d_%s",s,name.c_str()));
    h2_ele_ecInner_ecOuter[s]         = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_ele_ecInner_ecOuter_sect%d_%s",s,name.c_str()));
    h2_ele_samplingFraction_nphe[s]   = (TH2D*) inputFile->Get(Form("StandardHistograms/h2_ele_samplingFraction_nphe_sect%d_%s",s,name.c_str()));
